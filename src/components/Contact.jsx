          ...
          <div className="-mx-4 flex flex-wrap md:mt-20 lg:justify-between">
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-10 max-w-[570px] lg:mb-0 px-4">
                ...
                {/* <h2 className="mb-6 text-3xl font-bold uppercase text-blue-300 xl:text-6xl px-4 justify-center flex md:block">
                ...
                <p className="mb-9 text-gray-600 dark:text-gray-400 text-sm font-feedback font-medium leading-relaxed text-body-color  px-8 text-justify">
                  Reach out for personalized assistance and inquiries. We're
                  here to help you navigate your health journey with expert
                ...
                <div className="mb-8 flex w-full max-w-[370px] ">
                  ...
                  <div className="w-full">
                    <h4 className="mb-1 md:text-xl text-lg font-semibold text-dark  ">
                      Our Location
                    </h4>
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    <h4 className="mb-1 md:text-xl text-lg font-semibold  ">
                      Phone Number
                    </h4>
              ...
              <div className="relative md:h-[520px] rounded-lg bg-white p-4 shadow-lg  sm:p-8">
                <form>
                  ...
                  <div>
                    <button
                      type="submit"
                      className="w-full rounded border border-primary bg-btn2 p-3 text-white transition hover:bg-opacity-90"
                    >
                      Send Message
                    </button>
                  </div>
